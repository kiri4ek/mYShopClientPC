...
namespace mYShop
{
    public partial class DiscountControl : UserControl
    {
        public int str;
        int[] s_id;
        DiscountProductControl[] products;
        ...
        public void ReloadDiscount()
        {
            ...
            if (products != null)
                foreach (DiscountProductControl product in products)
            ...
            if (functions.str != "" & functions.connect)
            {
                ...
                products = new DiscountProductControl[str];
        ...
        public void Display(Functions functions, int i, int id)
        {
            ...
            products[i] = new DiscountProductControl
            {
                ID = id,
        ...
        {
            DiscountProductControl product = (sender as Control).Parent as DiscountProductControl;
